...
import useAutocomplete, { createFilterOptions } from '@material-ui/lab/esm/useAutocomplete/useAutocomplete';

export { createFilterOptions };

export const styles = (theme: { zIndex: { modal: any; }; typography: { body1: any; }; palette: { text: { secondary: any; }; action: { selected: any; hover: any; disabledOpacity: any; }; background: { paper: any; }; }; breakpoints: { up: (arg0: string) => any; }; }) => ({
