...
const badgeIntentStyles = (
  ...
  intentStyles = {
    ...
    backgroundColor: tokenObj[`badge-${variant}-${intent}-background-color`],
  };
  if (variant === "outline") {
    intentStyles = {
      ...intentStyles,
        ...
        {LeadingIcon && (
          <Box
            style={{
              marginRight:
                size === "large"
                  ? tokenObj["badge-icon-large-leading-icon-margin-right"]
        ...
        {TrailingIcon && (
          <Box
            style={{
              marginLeft:
                size === "large"
                  ? tokenObj["badge-icon-large-trailing-icon-margin-left"]
...
const Badge = React.forwardRef<HTMLDivElement, BadgeProps>((props, ref) => {
  return <BadgeComponent {...props} forwardedRef={ref} />;
});
