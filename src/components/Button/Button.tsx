...
const captilizeFirstLetter = (str: string) =>
...
const palette: Palette = {
  muted: {
    primary: {
      ...
      backgroundPressed:
        colorObj["button-color-muted-primary-background-pressed"],
    ...
    secondary: {
      ...
      background: "",
      backgroundHover:
        colorObj["button-color-muted-secondary-background-hover"],
      backgroundPressed:
        colorObj["button-color-muted-secondary-background-pressed"],
    ...
    tertiary: {
      ...
      backgroundPressed:
        colorObj["button-color-muted-tertiary-background-pressed"],
    ...
    selected: {
      ...
      backgroundPressed:
        colorObj["button-color-muted-selected-background-pressed"],
  ...
  mutedLight: {
    primary: {
      ...
      backgroundHover:
        colorObj["button-color-muted-light-primary-background-hover"],
      backgroundPressed:
        colorObj["button-color-muted-light-primary-background-pressed"],
      disabledText: colorObj["button-color-muted-light-primary-disabled-label"],
      disabled:
        colorObj["button-color-muted-light-primary-disabled-background"],
    },
    secondary: {
      ...
      borderPressed:
        colorObj["button-color-muted-light-secondary-border-pressed"],
      background: "",
      backgroundHover: hexToRgba(
        colorObj["button-color-muted-light-secondary-background-hover"],
        colorObj["button-color-muted-light-secondary-background-hover-opacity"]
      ),
      backgroundPressed: hexToRgba(
        colorObj["button-color-muted-light-secondary-background-pressed"],
        colorObj[
          "button-color-muted-light-secondary-background-pressed-opacity"
        ]
      ),
      disabledText:
        colorObj["button-color-muted-light-secondary-disabled-label"],
    ...
    tertiary: {
      ...
      background: "",
      backgroundHover: hexToRgba(
        colorObj["button-color-muted-light-tertiary-background-hover"],
        colorObj["button-color-muted-light-tertiary-background-hover-opacity"]
      ),
      backgroundPressed: hexToRgba(
        colorObj["button-color-muted-light-tertiary-background-pressed"],
        colorObj["button-color-muted-light-tertiary-background-pressed-opacity"]
      ),
      disabledText:
        colorObj["button-color-muted-light-tertiary-disabled-label"],
    },
    selected: {
      ...
      backgroundHover:
        colorObj["button-color-muted-light-selected-background-hover"],
      backgroundPressed:
        colorObj["button-color-muted-light-selected-background-pressed"],
      disabledText:
        colorObj["button-color-muted-light-selected-disabled-label"],
    },
  },
  prime: {
    primary: {
      ...
      backgroundPressed:
        colorObj["button-color-prime-primary-background-pressed"],
    ...
    secondary: {
      ...
      background: "",
      backgroundHover:
        colorObj["button-color-prime-secondary-background-hover"],
      backgroundPressed:
        colorObj["button-color-prime-secondary-background-pressed"],
    ...
    tertiary: {
      ...
      backgroundPressed:
        colorObj["button-color-prime-tertiary-background-pressed"],
    ...
    selected: {
      ...
      backgroundPressed:
        colorObj["button-color-prime-selected-background-pressed"],
  ...
  critical: {
    primary: {
      ...
      backgroundHover:
        colorObj["button-color-critical-primary-background-hover"],
      backgroundPressed:
        colorObj["button-color-critical-primary-background-pressed"],
    ...
    secondary: {
      ...
      background: "",
      backgroundHover:
        colorObj["button-color-critical-secondary-background-hover"],
      backgroundPressed:
        colorObj["button-color-critical-secondary-background-pressed"],
    ...
    tertiary: {
      ...
      background: "",
      backgroundHover:
        colorObj["button-color-critical-tertiary-background-hover"],
      backgroundPressed:
        colorObj["button-color-critical-tertiary-background-pressed"],
    ...
    selected: {
      ...
      backgroundHover:
        colorObj["button-color-critical-selected-background-hover"],
      backgroundPressed:
        colorObj["button-color-critical-selected-background-pressed"],
  ...
  info: {
    primary: {
      ...
      backgroundPressed:
        colorObj["button-color-info-primary-background-pressed"],
    ...
    secondary: {
      ...
      backgroundPressed:
        colorObj["button-color-info-secondary-background-pressed"],
    ...
    tertiary: {
      ...
      backgroundPressed:
        colorObj["button-color-info-tertiary-background-pressed"],
    ...
    selected: {
      ...
      backgroundPressed:
        colorObj["button-color-info-selected-background-pressed"],
  ...
  success: {
    primary: {
      ...
      backgroundHover:
        colorObj["button-color-success-primary-background-hover"],
      backgroundPressed:
        colorObj["button-color-success-primary-background-pressed"],
    ...
    secondary: {
      ...
      background: "",
      backgroundHover:
        colorObj["button-color-success-secondary-background-hover"],
      backgroundPressed:
        colorObj["button-color-success-secondary-background-pressed"],
    ...
    tertiary: {
      ...
      background: "",
      backgroundHover:
        colorObj["button-color-success-tertiary-background-hover"],
      backgroundPressed:
        colorObj["button-color-success-tertiary-background-pressed"],
    ...
    selected: {
      ...
      backgroundHover:
        colorObj["button-color-success-selected-background-hover"],
      backgroundPressed:
        colorObj["button-color-success-selected-background-pressed"],
  ...
  warning: {
    primary: {
      ...
      backgroundHover:
        colorObj["button-color-warning-primary-background-hover"],
      backgroundPressed:
        colorObj["button-color-warning-primary-background-pressed"],
    ...
    secondary: {
      ...
      background: "",
      backgroundHover:
        colorObj["button-color-warning-secondary-background-hover"],
      backgroundPressed:
        colorObj["button-color-warning-secondary-background-pressed"],
    ...
    tertiary: {
      ...
      background: "",
      backgroundHover:
        colorObj["button-color-warning-tertiary-background-hover"],
      backgroundPressed:
        colorObj["button-color-warning-tertiary-background-pressed"],
    ...
    selected: {
      ...
      backgroundHover:
        colorObj["button-color-warning-selected-background-hover"],
      backgroundPressed:
        colorObj["button-color-warning-selected-background-pressed"],
  ...
  () => {
    ...
    for (keys in palette) {
      resultObj["primary" + captilizeFirstLetter(keys)] = {
        ...
        "&:focus-visible": {
          boxShadow:
            "0px 0px 0px 4px " + getFocusColor(palette[keys].primary.shadow),
        },
        "&:active": {
      ...
      resultObj["secondary" + captilizeFirstLetter(keys)] = {
        ...
        "&:focus-visible": {
          boxShadow:
            "0px 0px 0px 4px " + getFocusColor(palette[keys].secondary.shadow),
        },
        "&:active": {
      ...
      resultObj["tertiary" + captilizeFirstLetter(keys)] = {
        ...
        "&:focus-visible": {
          boxShadow:
            "0px 0px 0px 4px " + getFocusColor(palette[keys].tertiary.shadow),
        },
        "&:disabled": {
      ...
      resultObj["selected" + captilizeFirstLetter(keys)] = {
        ...
        "&:focus": {
          boxShadow:
            "0px 0px 0px 4px " + getFocusColor(palette[keys].selected.shadow),
        },
        "&:disabled": {
...
const ButtonComponent = ({
  ...
  const StyledButton = withStyles(
    getStyles(size, padding, fontSize, lineHeight, borderRadius, buttonType)
  )(({ classes }: ButtonProps) => {
    ...
    return (
      <ThemeProvider theme={getThemeObj(size || "small")}>
        {buttonType === "icon" ? (
          <IconButton
            {...attrs}
            className={`${className} ${attrs.className}`}
            style={{ ...style }}
          >
            {attrs.children}
          </IconButton>
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (props, ref) => {
    return <ButtonComponent {...props} forwardedRef={ref} />;
  }
);
